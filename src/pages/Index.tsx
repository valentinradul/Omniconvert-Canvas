  ...
  return (
    <div className="min-h-screen font-inter">
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-black mb-4">We craft tech products since 2013</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-8 max-w-6xl mx-auto">
              ...
              <div className="relative z-20 flex-1 flex flex-col justify-between">
                <div className="space-y-4">
                  <div className="h-20 flex items-center justify-center">
                    <img src={exploreLogo} alt="Explore" className="h-11 w-30 object-contain" />
                  </div>
            ...
            <div className="text-center space-y-4 relative group cursor-pointer transition-all duration-300 hover:pb-4 hover:-mx-[5px] min-h-[180px] flex flex-col">
              ...
              <div className="relative z-20 flex-1 flex flex-col justify-between">
                <div className="space-y-4">
                  <div className="h-20 flex items-center justify-center">
                    <img src={revealLogo} alt="Reveal" className="h-11 w-30 object-contain" />
                  </div>
                  <p className="text-sm text-gray-600">
            ...
            <div className="text-center space-y-4 relative group cursor-pointer transition-all duration-300 hover:pb-4 hover:-mx-[5px] min-h-[180px] flex flex-col">
              ...
              <div className="relative z-20 flex-1 flex flex-col justify-between">
                <div className="space-y-4">
                  <div className="h-20 flex items-center justify-center">
                    <img src={pulseLogo} alt="Pulse" className="h-11 w-30 object-contain" />
                  </div>
                  <p className="text-sm text-gray-600">
            ...
            <div className="text-center space-y-4 relative group cursor-pointer transition-all duration-300 hover:pb-4 hover:-mx-[5px] min-h-[180px] flex flex-col">
              ...
              <div className="relative z-20 flex-1 flex flex-col justify-between">
                <div className="space-y-4">
                  <div className="h-20 flex items-center justify-center">
                    <img src={croBenchmarkLogo} alt="CRO Benchmark" className="h-11 w-30 object-contain" />
                  </div>
                  <p className="text-sm text-gray-600">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a href="https://x.com/omniconvert" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
                <span className="sr-only">Twitter</span>
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84"></path>
                </svg>
              </a>
              <a href="https://www.linkedin.com/company/omniconvert/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
